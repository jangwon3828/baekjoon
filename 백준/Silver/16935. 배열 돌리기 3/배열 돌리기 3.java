...
public class Main {
   ...
   static int r;
    public static void main(String[] args) {
        ...
        for (int i = 0; i < r; i++) {
            switch (sc.nextInt()){
                case 1:arr=oper1(arr);break;
                case 2:arr=oper2(arr);break;
                case 3:arr=oper3(arr);break;
                case 4:arr=oper4(arr);break;
                case 5:arr=oper5(arr);break;
                case 6:arr=oper6(arr);break;
            }
        }
